...
- [reference/learning-mode.md](reference/learning-mode.md): the opt-in `learn: <topic>` mode — the trigger, the grounding contract, and the v1 skill catalog
