...
The rules every mode obeys live in [reference/session-modes.md](../../../reference/session-modes.md): the non-negotiables, the intelligent feature-count routing, the one-of-each hard gate, and how Flight Plan feeds Chart a Course. Read it alongside this; it governs, and this file never drifts from it.
